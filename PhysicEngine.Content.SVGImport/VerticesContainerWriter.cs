...
using PhysicEngine.Content.SVGImport.Objects;

namespace PhysicEngine.Content.SVGImport
{
    [ContentTypeWriter]
    public class VerticesContainerWriter : ContentTypeWriter<VerticesContainer>
    {
        ...
        public override string GetRuntimeReader(TargetPlatform targetPlatform) => typeof(VerticesContainerReader).AssemblyQualifiedName;
    }
}