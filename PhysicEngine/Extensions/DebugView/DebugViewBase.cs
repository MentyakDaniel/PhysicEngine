...
namespace PhysicEngine.Extensions.DebugView
{
    public abstract class DebugViewBase
    {
        ...
        public void AppendFlags(DebugViewFlags flags) => Flags |= flags;

        /// <summary>Remove flags from the current flags.</summary>
        /// <param name="flags">The flags.</param>
        public void RemoveFlags(DebugViewFlags flags) => Flags &= ~flags;
