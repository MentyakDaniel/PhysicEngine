...
using PhysicEngine.Tools.ConvexHull.GiftWrap;
using PhysicEngine.Tools.Triangulation.Bayazit;
using PhysicEngine.Tools.Triangulation.Delaunary;
using PhysicEngine.Tools.Triangulation.Earclip;
using PhysicEngine.Tools.Triangulation.FlipCode;
using PhysicEngine.Tools.Triangulation.Seidel;
using PhysicEngine.Utilities;
using System;
using System.Collections.Generic;
using System.Diagnostics;

namespace PhysicEngine.Tools.Triangulation.TriangulationBase
{
