    ...
    internal class D14_RacingCar : PhysicsDemoScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            // car
            {
                ...
                JoinHelper.LinearStiffness(_hzBack, _zeta, _springBack.BodyA, _springBack.BodyB, out float stiffness, out float damping);
                ...
                JoinHelper.LinearStiffness(_hzFront, _zeta, _springFront.BodyA, _springFront.BodyB, out stiffness, out damping);
        ...
        public override void Update(GameTime gameTime, bool otherScreenHasFocus, bool coveredByOtherScreen)
        {
            ...
            if (Math.Abs(_springBack.MotorSpeed) < _maxSpeed * 0.01f)
